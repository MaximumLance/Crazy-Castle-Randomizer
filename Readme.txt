...
3. Run the Randomizer Logic script. It will ask for the Randomized ROM you created. Load the file into it and it will program the game to accept the randomized values generated by the Simple Randomizer Maker.
